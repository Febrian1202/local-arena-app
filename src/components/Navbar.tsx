  ...
  return (
    <nav className="fixed top-4 left-1/2 -translate-x-1/2 z-50 w-[90%] max-w-3xl">
      <div className="glass rounded-full px-4 py-2.5 flex items-center justify-between neon-border-cyan">
        ...
        <Link
          href={"/"}
          className="text-sm md:text-base font-bold tracking-wider text-primary flex items-center gap-1.5 shrink-0"
        >
          <span>🏆</span>
          <span className="text-glow-cyan font-heading">LOCAL ARENA</span>
        </Link>
